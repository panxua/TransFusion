...
train_pipeline = [  # Training pipeline
    ...
    dict(
        ...
        img_scale=(800, 448),  # The largest scale of image
        keep_ratio=True
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(800, 449),  # Decides the largest scale for testing, used for the Resize pipeline
...
data = dict(
    ...
    train=dict(  # Train dataset config
        type=dataset_type,
        data_root=data_root,
        ann_file='vod_radar_infos_train.pkl',
        pipeline=train_pipeline,
    ),
    val=dict(  # Validation dataset config
        type=dataset_type,
        data_root=data_root,
        ann_file='vod_radar_infos_val.pkl',
        pipeline=test_pipeline),
    test=dict(  # Test dataset config, modify the ann_file for test-dev/test submission
        type=dataset_type,
        data_root=data_root,
        ann_file='vod_radar_infos_test.pkl',
        pipeline=test_pipeline))
