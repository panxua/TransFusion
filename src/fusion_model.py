...
img_file = "checkpoints/resnet50.pth"  #"work_dirs/transfusion_vod_C/LSSFPN_e23/epoch_23.pth"
pts_file = None #"models/transfusion_l_epoch_5.pth"
output_file = "checkpoints/baseline_L.pth"
